...
DIV maintains relationships across USAID by regularly engaging Agency partners during its award selection process and sharing results with technical program officers in Washington and USAID Missions across the globe. At the end of each evaluation, we organize brown bags that are open to all interested colleagues and stakeholders. Additionally, all grantees are required to submit evaluations and anonymized data to USAID’s public platforms ([here](https://dec.usaid.gov/dec/home/Default.aspx) and [here](https://data.usaid.gov/)). DIV has also commissioned several independent look-back <a href="https://usaidinnovation.my.salesforce.com/sfc/p/#t0000000TZKp/a/t0000002eELr/M1L3LM8Pi0Utc_UAymSixNvBQ4Fzglx2sUlCFNnmsrE">reports</a> assessing its longer-term results in key countries. 
